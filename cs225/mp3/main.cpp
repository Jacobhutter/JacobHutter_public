...
void testSplit()
{
    ...
    List<int> list12;
      ...
      list12.insertBack(i);
		cout << list12 << endl;
      List<int> list11 = list12.split(4);
    cout << list12 << endl;
    cout << list11 << endl;
...
void testMerge()
{
  cout << "[main]: " << __func__ << "()" << endl;
    List<int> list111;
    list111.insertFront(11);
    list111.insertFront(1);
    List<int> list3333;
    list3333.insertFront(3);
    cout << list111 << " " << list3333 << endl;
    list111.mergeWith(list3333);
    cout << list111 << endl;
    PNG im1("in_08.png");
    PNG im2("in_09.png");
    PNG out(600, 400);
...
void testSort()
{
    ...
    PNG b2 = b.genImg(v, d);
    b2.writeToFile("in_02_shuffled_60.png");
    ...
    checkSoln("testSort", b3, "in_02.png");
    ...
    PNG q = b.genImg(v, d);
    q.writeToFile("in_02_shuffled_1.png");
