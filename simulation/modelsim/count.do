...
add wave -noupdate -label Registers -radix hexadecimal -childformat {{{/mp3_tb/dut/mp3_cpu/cd/r/data[7]} -radix hexadecimal} {{/mp3_tb/dut/mp3_cpu/cd/r/data[6]} -radix hexadecimal} {{/mp3_tb/dut/mp3_cpu/cd/r/data[5]} -radix hexadecimal} {{/mp3_tb/dut/mp3_cpu/cd/r/data[4]} -radix hexadecimal} {{/mp3_tb/dut/mp3_cpu/cd/r/data[3]} -radix hexadecimal} {{/mp3_tb/dut/mp3_cpu/cd/r/data[2]} -radix hexadecimal} {{/mp3_tb/dut/mp3_cpu/cd/r/data[1]} -radix hexadecimal} {{/mp3_tb/dut/mp3_cpu/cd/r/data[0]} -radix hexadecimal}} -expand -subitemconfig {{/mp3_tb/dut/mp3_cpu/cd/r/data[7]} {-color Gold -height 22 -radix hexadecimal} {/mp3_tb/dut/mp3_cpu/cd/r/data[6]} {-color Gold -height 22 -radix hexadecimal} {/mp3_tb/dut/mp3_cpu/cd/r/data[5]} {-color Gold -height 22 -radix hexadecimal} {/mp3_tb/dut/mp3_cpu/cd/r/data[4]} {-color Gold -height 22 -radix hexadecimal} {/mp3_tb/dut/mp3_cpu/cd/r/data[3]} {-color Gold -height 22 -radix hexadecimal} {/mp3_tb/dut/mp3_cpu/cd/r/data[2]} {-color Gold -height 22 -radix hexadecimal} {/mp3_tb/dut/mp3_cpu/cd/r/data[1]} {-color Gold -height 22 -radix hexadecimal} {/mp3_tb/dut/mp3_cpu/cd/r/data[0]} {-color Gold -height 22 -radix hexadecimal}} /mp3_tb/dut/mp3_cpu/cd/r/data
...
add wave -noupdate -radix hexadecimal /mp3_tb/dut/mp3_cpu/cd/ifid_register/ready
add wave -noupdate -radix hexadecimal /mp3_tb/dut/mp3_cpu/cd/idex_register/ready
add wave -noupdate -radix hexadecimal /mp3_tb/dut/mp3_cpu/cd/exmem_register/ready
add wave -noupdate -radix hexadecimal /mp3_tb/dut/mp3_cpu/cd/mem_ctrl_unit/ready
add wave -noupdate -color Gold -label i_cache_hit -radix hexadecimal /mp3_tb/dut/mp3_cpu/cd/i_cache_hits_counter/count
add wave -noupdate /mp3_tb/dut/mp3_cpu/cd/i_cache_hits_counter/internal_count
...
add wave -noupdate /mp3_tb/dut/mp3_cpu/cd/branch_predictor/stall
add wave -noupdate /mp3_tb/dut/mp3_cpu/cd/stalls_counter/internal_count
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {342841 ps} 0}
...
update
WaveRestoreZoom {0 ps} {627148 ps}
